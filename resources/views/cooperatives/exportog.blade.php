<table>
    <thead>
        <tr>
            ...
            <th>Nom Prenom President</th>
            <th>Contact President</th>
            <th>Sexe President</th>
        </tr>
    </thead>
    <tbody>
        @foreach ($organegestions as $foncorgcoop)
        <tr>
            ...
            <td>{{$foncorgcoop->nomPrenomPresident}}</td>
            <td>{{$foncorgcoop->contactPresident}}</td>
            <td>{{$foncorgcoop->sexePresident}}</td>
        </tr>
        @endforeach
    </tbody>
</table>
