            ...
            <table id="typeenvoyeurTable" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{$formation->specialite->libelleSpecialite}}</td>
                    <td>{{$formation->coutFormation}}</td>
                    <td>{{$formation->sourcefinancement->libelleSourceFinancement}}</td> 
                    <td>{{$formation->nbreHomme}}</td>
                    <td>{{$formation->nbreFemme}}</td>
                    ...
                    <td>
                        ...
                        <div class="modal fade" id="{{'modifier'.$formation->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <form action="{{url('/update-formationcarte/'.$formation->id)}}" method="POST">
                              @csrf
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-6">
                                      <div class="form-group">
                                        ...
                                        <small id="helpId" class="text-muted" ><span style="color: red">la specialite est obligatoire</span></small>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                        <label for="">Nombre homme</label>
                                        <input type="integer"   name="nbreHomme" id="" class="form-control" placeholder="nombre" aria-describedby="helpId">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                        <label for="">Nombre Femme</label>
                                        <input type="integer"   name="nbrefemme" id="" class="form-control" placeholder="nombre" aria-describedby="helpId">
                                        <small id="helpId" class="text-muted" ><span style="color: red"> est obligatoire</span></small>
                                        </div>
                                    </div>
                                </div>
                     ...
                     <div class="row">
                      ...
                      <div class="row">
                        <div class="col-lg-12 col-sm-12  col-md-12">
                          ...
                          <a href="{{url('/delete-formationcontinue/'.$formation->id)}}" class="btn btn-danger">supprimer <i class="fa fa-trash" style="color: white"></i></a>
                        </div>
                      </div>
                   </div>
                 </div>
...
<div class="modal fade" id="modal-lg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form action="{{url('/save-formationcarte')}}" method="POST">
      @csrf
    <div class="modal-content">
      <div class="modal-header modal-header-designed">
        <h5 class="modal-title" id="exampleModalLabel">Ajouter une formation carte</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        ...
        <div class="col-6">
            <div class="form-group">
              <label for="">Nombre homme</label>
              <input type="integer"   name="nbreHomme" id="" class="form-control" placeholder="nombre Homme" aria-describedby="helpId">
              <small id="helpId" class="text-muted" ><span style="color: red"> est obligatoire</span></small>
            </div>
          </div>
          ...
          <div class="col-6">
            <div class="form-group">
              <label for="">Nombre Femme</label>
              <input type="integer"   name="nbrefemme" id="" class="form-control" placeholder="le theme de la formation" aria-describedby="helpId">
              <small id="helpId" class="text-muted" ><span style="color: red"> est obligatoire</span></small>
            </div>
          </div>
        </div>
