                    ...
                    <td>
                        ...
                        <div class="modal fade" id="{{'modifier'.$affecte->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <form action="{{url('/update-affectation-formationinitiale/'.$affecte->id)}}" method="POST">
                              @csrf
                                      ...
                                      <div class="form-group">
                                        ...
                                        <select name="type_formation_id" class="form-control" id="">
                                            @foreach ($types as $type)
                                                <option @if ($type->id==$affecte->typeformation->id)
                                                    selected
                                  ...
                                  <div class="row">
                                    <div class="col-lg-6">
                                      <div class="form-group">
                                        ...
                                        <input type="integer"  value="{{$affecte->duree}}" name="duree" id="" class="form-control" placeholder="la duree" aria-describedby="helpId">
                     ...
                     <div class="row">
                      ...
                      <div class="row">
                        <div class="col-lg-12 col-sm-12  col-md-12">
                          ...
                          <a href="{{url('/delete-affectation-formationinitiale/'.$affecte->id)}}" class="btn btn-danger">supprimer <i class="fa fa-trash" style="color: white"></i></a>
                        </div>
                      </div>
                   </div>
                 </div>
...
<div class="modal fade" id="modal-lg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form action="{{url('/save-affectation-formationinitiale')}}" method="POST">
      @csrf
    <div class="modal-content">
      <div class="modal-header modal-header-designed">
