                                  ...
                                  <div class="row">
                                    <div class="col-lg-12">
                                      <div class="form-group">
                                        ...
                                        <input type="text" value="{{$aproche->approchePedagogique}}" name="approchePedagogique" id="" class="form-control" placeholder="la region" aria-describedby="helpId">
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="form-group">
                ...
                <input type="text" name="approchePedagogique" id="" class="form-control" placeholder="approche pedagogique" aria-describedby="helpId">
