                    ...
                    <td>
                        ...
                        <div class="modal fade" id="{{'modifier'.$affecte->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <form action="{{url('/update-affectation-formationcontinue/'.$affecte->id)}}" method="POST">
                              @csrf
                                  ...
                                  <div class="row">
                                    <div class="col-lg-6">
                                      <div class="form-group">
                                        ...
                                        <input type="integer"  name="duree" id="" class="form-control" value="{{$affecte->duree}}" placeholder="la duree" aria-describedby="helpId">
                     ...
                     <div class="row">
                      ...
                      <div class="row">
                        <div class="col-lg-12 col-sm-12  col-md-12">
                          ...
                          <a href="{{url('/delete-affectation-formationcontinue/'.$affecte->id)}}" class="btn btn-danger">supprimer <i class="fa fa-trash" style="color: white"></i></a>
                        </div>
                      </div>
                   </div>
                 </div>
...
<div class="modal fade" id="modal-lg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form action="{{url('/save-affectation-formationcontinue')}}" method="POST">
      @csrf
    <div class="modal-content">
      <div class="modal-header modal-header-designed">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
              <div class="form-group">
                <label for="">Théme</label>
                <input type="text" name="theme" id="" class="form-control" placeholder="le theme" aria-describedby="helpId" required>
                <small id="helpId" class="text-muted" ><span style="color: red">le theme est obligatoire</span></small>
              </div>
            </div>
            <div class="col-lg-6">
