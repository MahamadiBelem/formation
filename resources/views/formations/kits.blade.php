...
<div class="row" style="margin-top: 5%;margin-left: -50%">
  <div class="card-body">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <div class="modal fade" id="{{'modifier'.$kit->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <form action="{{url('/update-type-kits/'.$kit->id)}}" method="POST">
                              @csrf
                            <div class="modal-content">
                              <div class="modal-header modal-header-designed">
                                <h5 class="modal-title" id="exampleModalLabel">Modifier un kit d installation </h5>
                              ...
                              <div class="modal-body">
                                <div class="row">
                                  <div class="col-6">
                                    <input hidden name="id"  value="{{$kit->id}}" type="text">
                                  </div>
                                </div>
                                  <div class="row">
                                    <div class="col-lg-6">
                                      <div class="form-group">
                                        ...
                                        <input type="text"  value="{{$kit->libelleKits}}" name="libelleKits" id="" class="form-control" placeholder="le libelle du kit" aria-describedby="helpId">
                                    ...
                                    <div class="col-6">
                                      <div class="form-group">
                                        ...
                                        <input type="text"  value="{{$kit->quantites}}" name="quantites" id="" class="form-control" placeholder="la quantite du kit" aria-describedby="helpId">
    ...
    <div class="modal fade" id="{{'suprimer'.$kit->id}}">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header modal-delete-header">
              <h4 class="modal-title">Supprimer un kit</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
                     ...
                     <div class="row">
                      ...
                      <div class="row">
                        <div class="col-lg-12 col-sm-12  col-md-12">
                          ...
                          <a href="{{url('/delete-type-kits/'.$kit->id)}}" class="btn btn-danger">supprimer <i class="fa fa-trash" style="color: white"></i></a>
                        </div>
                      </div>
                   </div>
                 </div>
...
<div class="modal fade" id="modal-lg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form action="{{url('/save-type-kits')}}" method="POST">
      @csrf
    <div class="modal-content">
      <div class="modal-header modal-header-designed">
        <h5 class="modal-title" id="exampleModalLabel">Ajouter un kit</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
