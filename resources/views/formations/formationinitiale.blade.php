                    ...
                    <td>
                        ...
                        <div class="modal fade" id="{{'modifier'.$formation->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <form action="{{url('/update-formationinitiale/'.$formation->id)}}" method="POST">
                              @csrf
                                  ...
                                  <div class="row">
                                    <div class="col-lg-6">
                                      <div class="form-group">
                                        <label for="">Domaine de la formation</label>
                                        <input type="text"  value="{{$formation->libelleFormations}}" name="libelleFormations" id="" class="form-control" placeholder="Saisiez le libelle de la formation" aria-describedby="helpId" required>
                     ...
                     <div class="row">
                      ...
                      <div class="row">
                        <div class="col-lg-12 col-sm-12  col-md-12">
                          ...
                          <a href="{{url('/delete-formationinitiale/'.$formation->id)}}" class="btn btn-danger">supprimer <i class="fa fa-trash" style="color: white"></i></a>
                        </div>
                      </div>
                   </div>
                 </div>
...
<div class="modal fade" id="modal-lg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form action="{{url('/save-formationinitiale')}}" method="POST">
      @csrf
    <div class="modal-content">
      <div class="modal-header modal-header-designed">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="form-group">
              <label for="">Domaine de la formation</label>
              <input type="text"   name="libelleFormations" id="" class="form-control" placeholder="Saisiez le libelle de la formation" aria-describedby="helpId" required>
              <small id="helpId" class="text-muted" ><span style="color: red">le libelle de la formation est obligatoire</span></small>
            </div>
          </div>
