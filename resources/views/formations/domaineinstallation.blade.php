                  ...
                  <tr>
                    ...
                    <td>
                      @foreach ($domaine->kits as $item)
                          <div>Kits:{{$item->libelleKits}} Quantite:{{$item->quantites}}</div>
                      @endforeach
                    </td> 
                    <td>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-6">
                                      <div class="form-group">
                                        ...
                                        <select class="form-control" name="kits[]" id="">
                                          
                                          @foreach ($kits as $kit)
                                          <option value="{{$kit->id}}">{{$kit->libelleKts}}</option>
                                          @endforeach
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header modal-delete-header">
              <h4 class="modal-title">Supprimer un domaine d installation</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
      ...
      <div class="modal-body">
        ...
        <div class="row">
          ...
          <div class="col-6">
            <div class="form-group">
              <label for="">Kits associés</label>
              <select class="form-control" name="kits[]" id="kits">
