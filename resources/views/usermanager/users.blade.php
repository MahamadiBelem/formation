            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card card-primary">
                           <div class="card-body">
                            <a href="{{url('/new-user')}}" class="btn btn-primary"  style="color: white; font-weight:bold;"> Nouveau <i class="fa fa-plus"></i></a>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header  bg-danger">
              <h4 class="modal-title">Suppression de l'utilisateur: {{$user->name}}</h4>
